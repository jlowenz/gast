...
\begin{figure}[ht]
\centering
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_smag_0}\includegraphics[width=0.2\linewidth]{figures/kitchen_smag_1}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_feats_0}\includegraphics[width=0.2\linewidth]{figures/kitchen_feats_1}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:meet_smag_0}\includegraphics[width=0.2\linewidth]{figures/meeting_smag_1}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:meet_feats_0}\includegraphics[width=0.2\linewidth]{figures/meeting_feats_1}\end{subfigure}\\
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_smag_1}\includegraphics[width=0.2\linewidth]{figures/kitchen_smag_3}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_feats_1}\includegraphics[width=0.2\linewidth]{figures/kitchen_feats_3}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:meet_smag_1}\includegraphics[width=0.2\linewidth]{figures/meeting_smag_3}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:meet_feats_1}\includegraphics[width=0.2\linewidth]{figures/meeting_feats_3}\end{subfigure}\\
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_smag_2}\includegraphics[width=0.2\linewidth]{figures/kitchen_smag_5}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_feats_2}\includegraphics[width=0.2\linewidth]{figures/kitchen_feats_5}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:meet_smag_2}\includegraphics[width=0.2\linewidth]{figures/meeting_smag_5}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:meet_feats_2}\includegraphics[width=0.2\linewidth]{figures/meeting_feats_5}\end{subfigure}\\
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_smag_3}\includegraphics[width=0.2\linewidth]{figures/kitchen_smag_7}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_feats_3}\includegraphics[width=0.2\linewidth]{figures/kitchen_feats_7}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:meet_smag_3}\includegraphics[width=0.2\linewidth]{figures/meeting_smag_7}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:meet_feats_3}\includegraphics[width=0.2\linewidth]{figures/meeting_feats_7}\end{subfigure}\\
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_smag_4}\includegraphics[width=0.2\linewidth]{figures/kitchen_smag_9}\end{subfigure}
\begin{subfigure}[]{0.2\linewidth}\label{fig:kit_feats_4}\includegraphics[width=0.2\linewidth]{figures/kitchen_feats_9}\end{subfigure}
